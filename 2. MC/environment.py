...
Para cualquier otro caso lo unico que debemos definir es nuestro 
propio entorno.

En el entorno vamos a definir nuestro problema y tendra las 
funciones mas importantes para definir y actualizar nuestro 
entorno y la percepción que el ser inteligente tiene acerca de el.
"""
...
class Environment(object):
    ...
    def update_env(self, direction, energy_ai, month):
        ...
        # ONTENCIÓN DEL SIGUIENTE ESTADO
        ...
        # Calcular la variación de temperatura intrinseca
        ...
        scaled_number_users = (self.current_number_users - self.min_number_users)/(self.max_temperature - self.min_temperature)
